...
// Get total elements
const yearsTotal = document.querySelector('.year-result');
const monthsTotal = document.querySelector('.month-result');
const daysTotal = document.querySelector('.day-result');
